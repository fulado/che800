...
# 每周日、周三2:30开启自动任务
scheduler.add_job(query_vio_auto_sz, 'cron', hour=20, minute=23, second=0)

# 每周日、周三凌2:00开始初始化神州买卖车查询状态
scheduler.add_job(backup_vio, 'cron', hour=20, minute=25, second=0)
scheduler.add_job(reset_vehicle, 'cron', hour=20, minute=25, second=0)
